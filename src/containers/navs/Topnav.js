...
const TopNav = ({
  ...
  const handleLogout = () => {
    // console.log("Title User",titelName)
      ...
      <div className="navbar-right">
        ...
        <div className="user d-inline-block">
          <UncontrolledDropdown className="dropdown-menu-right">
            ...
            localStorage.getItem("gogo_current_user") !=null?JSON.parse(localStorage.getItem("gogo_current_user")).title:"Default User"
